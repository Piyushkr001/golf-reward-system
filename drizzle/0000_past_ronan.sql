...
CREATE TYPE "public"."draw_logic_type" AS ENUM('random', 'algorithmic');--> statement-breakpoint
...
ALTER TABLE "golf_scores" ADD CONSTRAINT "golf_scores_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "prize_pools" ADD CONSTRAINT "prize_pools_draw_id_draws_id_fk" FOREIGN KEY ("draw_id") REFERENCES "public"."draws"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "golf_scores_user_date_idx" ON "golf_scores" USING btree ("user_id","score_date");--> statement-breakpoint
