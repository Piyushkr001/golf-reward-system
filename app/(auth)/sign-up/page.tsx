      ...
      <div className="w-full max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-white dark:bg-slate-900 px-3 text-slate-500 rounded-full">Or continue with</span>
          </div>
        </div>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-6">
          ...
          <Button disabled={loading} type="submit" size="lg" className="w-full h-12 bg-linear-to-r from-violet-600 to-cyan-500 hover:opacity-90 text-white rounded-xl shadow-lg shadow-violet-500/25 transition-all text-base font-semibold">
        ...
        <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
          ...
          <Link href="/sign-in" className="font-semibold text-violet-600 dark:text-violet-400 hover:underline">
            Sign In
          </Link>
        </p>
      </div>
